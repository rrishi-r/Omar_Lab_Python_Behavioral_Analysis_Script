...
Timeframe: The following code sample was developed and revised from January 22, 2023 - February 20, 2023 as part of a long term behavioral / conditioning experiment
...
ax.set_title('Poke Classification for Subject 1 and Subject 2')
ax.yaxis.grid(True)
...
plt.tight_layout()
plt.savefig("SEQFR2_Phase_Poke_Classification_Subject_1_and_Subject_2_Day_1_Data.png")
plt.show()
...
def plot_cont_poke_efficiency(df_1, df_2):
    ...
    # Save the figure and show in output
    plt.savefig("SEQFR2_Phase_Poke_Efficiency_Subject_1_and_Subject_2_Day_1_Data.png")
    plt.show()
